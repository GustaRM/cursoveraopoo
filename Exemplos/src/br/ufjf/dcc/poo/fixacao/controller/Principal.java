package br.ufjf.dcc.poo.fixacao.controller;

import java.util.ArrayList;

import br.ufjf.dcc.poo.fixacao.model.Aluno;
import br.ufjf.dcc.poo.fixacao.model.Disciplina;
import br.ufjf.dcc.poo.fixacao.model.Professor;
...
public class Principal {
	...
	public static void main(String[] args) {
		...
		disciplinasAluno.add(disciplina3);
		disciplinasAluno.add(disciplina4);
